...
def non_nsubj_to_verb(sent, nsubj,root):
    ...
    if sg_noun_list == []:
        ...
        nearest_noun_index = token_list.index(sg_noun_list[-1])
...
csv_reader = csv.reader(open("/Users/zhoujie/Desktop/pl_rest_subject_good_first_half_done_bert.csv"))
for line in csv_reader:
    ...
    print(line)
    with open("/Users/zhoujie/Desktop/paper_project/pl_sva_mask_full_para.csv", "a+") as f:
        writer = csv.writer(f)
        writer.writerow(line)

####duplicate csv file
# frame=pd.read_csv('/Users/zhoujie/Desktop/paper_project/pl_sva_mask_full_para.csv',engine='python')
# data = frame.drop_duplicates(subset=None, keep='first', inplace=False)
# data.to_csv('/Users/zhoujie/Desktop/paper_project/pl_sva_mask_full_para_duplicate.csv', encoding='utf8')
#
